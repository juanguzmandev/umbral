...
export default function Page() {
    return (
      <body className="bg-woods bg-center bg-cover bg-no-repeat flex h-screen justify-center w-full">
        <div className="bg-light bg-center bg-cover bg-no-repeat box-border flex flex-col justify-between opacity-70 py-14 text-center w-full lg:flex-row lg:py-8">
